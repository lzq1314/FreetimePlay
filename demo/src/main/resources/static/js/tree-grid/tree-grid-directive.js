    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          "       ng-class=\"'level-' + {{ row.level }} \" class=\"tree-grid-row\">\n" +
          "       <td  ng-class=\"{'danger' :row.branch['isSelected']}\"><div><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
          ...
          "       </td>\n" +
          "       <td ng-class=\"{'danger' : row.branch['isSelected']}\" ng-repeat=\"col in colDefinitions\">\n" +
          "         <div ng-if=\"col.cellTemplate\" xcompile=\"col.cellTemplate\" cell-template-scope=\"col.cellTemplateScope\"></div>\n" +
      ...
      function ($compile) {
        return {
          ...
          link    : function (scope, element, attrs) {
            ...
            scope.$watch(attrs.xcompile, function (new_val) {
              /*
